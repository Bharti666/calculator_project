...
btn_plus=tk.Button(root,text='+',command=lambda: add_to_calculator('+'),width=5)
btn_plus.grid(row=2,column=4)
btn_minus=tk.Button(root,text='-',command=lambda: add_to_calculator('-'),width=5)
btn_minus.grid(row=3,column=4)
btn_multi=tk.Button(root,text='*',command=lambda: add_to_calculator('*'),width=5)
btn_multi.grid(row=4,column=4)
btn_div=tk.Button(root,text='/',command=lambda: add_to_calculator('/'),width=5)
btn_div.grid(row=5,column=4)
btn_equal=tk.Button(root,text='=',command=evaluate_function,width=5)
btn_equal.grid(row=5,column=1)
btn_clear=tk.Button(root,text='C',command=clear_field,width=5)
